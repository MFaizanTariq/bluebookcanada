...
@scheduler.task('cron', id='1', hour='10', minute='16')
def news_fetch():
    news_fetch1('entertainment', 'australia', key2)
    news_fetch1('business', 'australia', key3)
    news_fetch1('sports', 'australia', key6)
    news_fetch1('health', 'australia', key7)
    news_fetch1('science', 'australia', key8)
    news_fetch1('technology', 'australia', key9)
    news_fetch1('entertainment', 'canada', key10)
    ...
    news_fetch1('science', 'canada', key8)
    news_fetch1('entertainment', 'india', key9)
    news_fetch1('business', 'india', key2)
    news_fetch1('sports', 'india', key3)
    news_fetch1('health', 'india', key6)
    news_fetch1('technology', 'india', key20)
