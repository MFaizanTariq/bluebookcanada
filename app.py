...
@scheduler.task('cron', id='1', hour='19', minute='48')
def news_fetch():
    ...
    news_fetch1('sports', 'canada', key3)
    news_fetch1('health', 'canada', key3)
    news_fetch1('technology', 'canada', key3)
    news_fetch1('science', 'canada', key3)
    news_fetch1('entertainment', 'india', key4)
    news_fetch1('business', 'india', key4)
    news_fetch1('sports', 'india', key4)
    news_fetch1('health', 'india', key4)
    news_fetch1('technology', 'india', key5)
    news_fetch1('science', 'india', key5)
    news_fetch1('entertainment', 'italy', key5)
    news_fetch1('business', 'italy', key5)
    news_fetch1('sports', 'italy', key6)
    news_fetch1('health', 'italy', key6)
    news_fetch1('technology', 'italy', key6)
    news_fetch1('science', 'italy', key6)
